...
namespace MudBlazor.Docs.Theme;

public static class Theme
{
    private static readonly PaletteDark DocsDarkPalette;
    private static readonly PaletteLight DocsLightPalette;
    private static readonly Typography DocsPageTypography;
    static Theme()
    {
        DocsDarkPalette = new PaletteDark()
        {
            Primary = "#7e6fff",
            Surface = "#1e1e2d",
            Background = "#1a1a27",
        ...
        DocsLightPalette = new PaletteLight()
        {
            Black = "#110e2d",
            AppbarText = "#424242",
        ...
        DocsPageTypography = new Typography()
        {
