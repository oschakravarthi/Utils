...
using System.Linq;
using SubhadraSolutions.Utils.Astronomy.CelestialObjects.Moons;
using SubhadraSolutions.Utils.Astronomy.CelestialObjects.Stars;
using SubhadraSolutions.Utils.Astronomy.Models;
using SubhadraSolutions.Utils.Astronomy.Planets;
using SubhadraSolutions.Utils.Astronomy.UnitsOfMeasure;

namespace SubhadraSolutions.Utils.Astronomy.Calculators
{
    /// <summary>
