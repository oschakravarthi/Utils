...
//            "#FF7F50", "#6495ED", "#6495ED", "#FFF8DC", "#DC143C", "#00FFFF", "#00008B", "#008B8B",
//            "#B8860B", "#A9A9A9", "#006400", "#A9A9A9", "#BDB76B", "#8B008B", "#556B2F", "#FF8C00",
//            "#9932CC", "#8B0000", "#E9967A", "#8FBC8F", "#483D8B", "#2F4F4F", "#2F4F4F", "#00CED1",
//            "#9400D3", "#FF1493", "#00BFFF", "#696969", "#696969", "#1E90FF", "#B22222", "#FFFAF0",
//            "#228B22", "#FF00FF", "#DCDCDC", "#F8F8FF", "#FFD700", "#DAA520", "#808080", "#008000",
//            "#ADFF2F", "#808080", "#F0FFF0", "#FF69B4", "#CD5C5C", "#4B0082", "#FFFFF0", "#F0E68C",
//            "#FFFF54", "#E6E6FA", "#FFF0F5", "#7CFC00", "#FFFACD", "#ADD8E6", "#F08080", "#E0FFFF",
//            "#FAFAD2", "#FAFAD2", "#D3D3D3", "#90EE90", "#D3D3D3", "#FFB6C1", "#FFA07A", "#20B2AA",
//            "#87CEFA", "#778899", "#778899", "#B0C4DE", "#FFFFE0", "#00FF00", "#32CD32", "#FAF0E6",
//            "#FF00FF", "#800000", "#7F0000", "#B03060", "#66CDAA", "#0000CD", "#BA55D3", "#9370DB",
...
//            "#FFC0CB", "#DDA0DD", "#B0E0E6", "#800080", "#7F007F", "#A020F0", "#663399", "#FF0000",
...
//        };
//        public static void GetUniqueColors(int numberOfColors)
//        {
//            var spectrum = 255 * 255 * 255;
//            var step = spectrum / numberOfColors;

//        }

//        public static HSLColor ColorToHSLColor(Color color)
//        {
//            var red = color.R;
//            var green = color.G;
//            var blue = color.B;
//            var r = (float)red / (float)255;
//            var g = (float)green / (float)255;
//            var b = (float)blue / (float)255;
...
//        public static List<Color> GetPalette(int n = 8, int Lmin = 5, int Lmax = 90, int maxLoops = 10000)
//        {
//            Color.fr
//            var data = new List<Color>();
//		for (var color in BaseColors.colors)
//            {
//                var c = chroma(color);
//                var L = 100 * c.hsl()[2];
//                if ((L >= Lmin) && (L <= Lmax))
...
//        public static void GetUniqueColors(int numberOfColors, int spectrumStart, int spectrumEnd)
//        {
//            var spectrum = spectrumEnd - spectrumStart;
//            var step = spectrum / numberOfColors;
