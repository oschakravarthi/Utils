...
/*
 ...
 4, 1,-1,-1,    0,-1719,
        ...
        static readonly double[] mean_node_corr = [
            -2.56,
         ...
         * in 100-year steps. corrections are set to 0 between the years 0 and 3000 */
        static readonly double[] mean_apsis_corr = [
            7.525,
        ...
        public int swi_moshmoon(double tjd, bool do_save, CPointer<double> xpmret, ref string serr) {
            ...
            if (tjd is < Sweph.MOSHLUEPH_START - 0.2 or > Sweph.MOSHLUEPH_END + 0.2) {
        ...
        public int swi_mean_node(double J, CPointer<double> pol, ref string serr) {
            ...
            if (J is < Sweph.MOSHNDEPH_START or > Sweph.MOSHNDEPH_END) {
                if (serr != null) {
