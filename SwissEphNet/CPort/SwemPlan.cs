...
namespace SwissEphNet.CPort
{
    ...
    class SwemPlan : BaseCPort
    {
        ...
        static readonly int[] pnoint2msh = [2, 2, 0, 1, 3, 4, 5, 6, 7, 8,];


        /* From Simon et al (1994)  */
        static readonly double[] freqs =
        [
        ...
        readonly Sweph.plantbl[] planets = [
            SwemTab.mer404,
            SwemTab.ven404,
            SwemTab.ear404,
            SwemTab.mar404,
        ...
        public int swi_moshplan(double tjd, int ipli, bool do_save, CPointer<double> xpret, CPointer<double> xeret, ref string serr) {
            ...
            if (tjd is < Sweph.MOSHPLEPH_START - 0.3 or > Sweph.MOSHPLEPH_END + 0.3) {
        ...
        public bool SE_NEELY = true;               /* use James Neely's revised elements 
                                         *      of Uranian planets*/
        static readonly string[] plan_fict_nam = [
