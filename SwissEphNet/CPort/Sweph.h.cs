...
namespace SwissEphNet.CPort
{
    ...
    partial class Sweph
    {
        ...
        */
        ...
        public int[] PNOINT2JPL = [ SweJPL.J_EARTH, SweJPL.J_MOON, SweJPL.J_MERCURY, SweJPL.J_VENUS, SweJPL.J_MARS, SweJPL.J_JUPITER,
        ...
        public static double[] pla_diam = [1392000000.0, /* Sun */
                                   3476300.0, /* Moon */
                                   2439000.0 * 2, /* Mercury */
                                   6052000.0 * 2, /* Venus */
                                   3397200.0 * 2, /* Mars */
        ...
        public class swe_data
        {
            ...
            public void Reset(bool full)
            {
                if (full)
                {
                    ...
                    astro_models = new Int32[SEI_NMODELS];
                }
                oec = new epsilon();
                oec2000 = new epsilon();
                nut = new nut();
